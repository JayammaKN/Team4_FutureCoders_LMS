...
Call log:
  - waiting for locator('//span[@class=\'p-radiobutton-icon\']').first()
    - locator resolved to <span class="p-radiobutton-icon"></span>
...
```ts
  ...
  25 |     this.programActiveCheckbox = page.locator("//span[@class='p-radiobutton-icon']").first();
