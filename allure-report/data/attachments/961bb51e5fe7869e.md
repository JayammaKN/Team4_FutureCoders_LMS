...
Call log:
  - waiting for locator('#Active').first()
    - locator resolved to <input id="Active" type="radio" value="Active" name="category" aria-checked="false"/>
...
```ts
  ...
  25 |     this.programActiveCheckbox = page.locator("#Active").first();
