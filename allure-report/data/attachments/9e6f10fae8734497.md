...
Call log:
  - waiting for locator('//div[@class=\'p-radiobutton-box\']').first()
    - locator resolved to <div class="p-radiobutton-box" ng-reflect-ng-class="[object Object]">…</div>
...
```ts
  ...
  25 |     this.programActiveCheckbox = page.locator("//div[@class='p-radiobutton-box']").first();
