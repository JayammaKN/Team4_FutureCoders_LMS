...
- grid:
  ...
  - rowgroup:
    - row "happylov Nova Description Active":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "happylov"
...
```ts
  ...
  98  |     await this.programNameField.fill(this.newProgramName);
  99  |     await this.programDescriptionField.fill(this.newProgramDescription);
