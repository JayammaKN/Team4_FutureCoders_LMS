...
Call log:
  - waiting for locator('//p-radiobutton[@id=\'category\']').first()
    - locator resolved to <p-radiobutton id="category" name="category" _ngcontent-bmg-c221="" ng-reflect-value="Active" ng-reflect-name="category" ng-reflect-input-id="Active" class="ng-untouched ng-pristine ng-valid">…</p-radiobutton>
        ...
        - generic [ref=e229]:
          - generic [ref=e230]:
            - generic [ref=e231]:
              - text: Name
              - generic [ref=e232]: "*"
            - textbox "Name *" [ref=e233]: Nova Program
          ...
          - generic [ref=e234]:
            ...
            - textbox "Description" [active] [ref=e236]: Nova Description
          - generic [ref=e237]:
...
> 54 |     await this.programActiveCheckbox.check();
     |                                      ^ Error: locator.check: Error: Not a checkbox or radio button
