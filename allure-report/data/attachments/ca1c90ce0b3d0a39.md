...
- Name: tests\features\program\program-editprg.feature.spec.js >> Edit Program Functional Verification >> Edit icon functionality
...
Call log:
  - waiting for locator('//button[@id=\'editProgram\']').first()
    - locator resolved to <button pbutton="" pripple="" id="editProgram" icon="pi pi-pencil" _ngcontent-dxk-c221="" ng-reflect-icon="pi pi-pencil" class="p-button-rounded p-button-success p-button p-component p-button-icon-only">…</button>
