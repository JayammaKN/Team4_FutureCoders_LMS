...
Locator: getByText('Nova Description Edited')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Nova Description Edited')
...
- button "Logout"
- alert:
  - text:  Successful Program Updated
  - button ""
- text: Manage Program
- button [disabled]
- text: 
- textbox "Search...": happythree
- grid:
  - rowgroup:
  ...
  - rowgroup:
    - row "happythree Nova Description Active":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "happythree"
...
> 87  |     await expect(this.page.getByText(this.newProgramDescription)).toBeVisible();
      |                                                                   ^ Error: expect(locator).toBeVisible() failed
