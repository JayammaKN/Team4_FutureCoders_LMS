...
Call log:
  ...
  - waiting for locator('#username')
    14 × locator resolved to <input matinput="" required="" id="username" aria-invalid="false" aria-required="true" _ngcontent-myn-c219="" ng-reflect-required="" data-placeholder="User" ng-reflect-id="username" ng-reflect-placeholder="User" formcontrolname="userLoginEmailId" ng-reflect-name="userLoginEmailId" class="mat-input-element mat-form-field-autofill-control ng-tns-c159-0 ng-untouched ng-pristine ng-invalid cdk-text-field-autofill-monitored"/>
