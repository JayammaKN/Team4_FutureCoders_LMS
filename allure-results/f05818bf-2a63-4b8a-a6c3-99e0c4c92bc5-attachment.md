...
- Name: tests/features/login.feature.spec.js >> Login Functionality >> Application Logo is displayed
- Location: .features-gen/tests/features/login.feature.spec.js:30:7
...
Locator: locator('img[alt="lms-logo"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('img[alt="lms-logo"]')

```

```yaml
- img
- paragraph: Please login to LMS application
- textbox "User"
- text: User
- textbox "Password"
- text: Password
- combobox "Select the role Select the role": Select the role
