...
- Name: tests/features/login.feature.spec.js >> Login Functionality >> Company name is displayed
- Location: .features-gen/tests/features/login.feature.spec.js:36:7
...
Call log:
  ...
  - waiting for locator('#companyName')
